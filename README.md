...
| Controller navigation | Partial | Focusable cards, debounced analog/hat navigation, LB/RB tabs, Back/B handling, nearest-neighbor focus restoration, and contextual Home/Library/Store/Media/PC X/Y actions; Downloads, Details and Settings context mappings plus physical-device/reconnect testing remain |
