...
- Expand the optional Windows companion with additional storefront discovery beyond Steam, richer streaming integrations, installer signing, and physical Windows validation
