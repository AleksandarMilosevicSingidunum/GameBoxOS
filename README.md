...
| Controller navigation | Partial | Focusable cards, debounced analog/hat navigation, LB/RB tabs, Back/B handling, nearest-neighbor focus restoration, and contextual Home/Library/Store/Downloads/Details/Media/PC X/Y actions including state-safe play/install/resume, favorite and batch transfer operations; Settings context mappings plus physical-device/reconnect testing remain |
